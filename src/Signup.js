...
class Signup extends Component{
    constructor(props){
        ...
        contactSubmit(e){
            ...
            // var registerArray = [];
            // registerArray = JSON.parse(localStorage.getItem('sigup-user')) || [];
            // registerArray.push(this.state.fields);
            // localStorage.setItem('sigup-user', JSON.stringify(registerArray));
