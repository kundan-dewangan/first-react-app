...
class FormValidator extends React.Component {
    ...
    getClassName = fieldName => {
        ...
        return field.isTouched && !field.isValid ? "border-danger" : "";
    };
            ...
            <div className="container mt-5 pt-5">
                <form>
                    <div className="field-group">
                        ...
                        <input
                            className={
                                firstName.isTouched && !firstName.isValid ? "border-danger" : ""
                            }
                            name="firstName"
                    ...
                    <div className="field-group">
                        ...
                        <input
                            className={
                                lastName.isTouched && !lastName.isValid ? "border-danger" : ""
                            }
                            name="lastName"
                    ...
                    <div className="field-group">
                        <label>Phone</label>
                        <input
                            className={phone.isTouched && !phone.isValid ? "border-danger" : ""}
                            name="phone"
                            minLength="10"
                            maxLength="10"
                    ...
                    <div className="field-group">
                        <label>Email</label>
                        <input
                            className={email.isTouched && !email.isValid ? "border-danger" : ""}
                            name="email"
